    ...
    <form class="form" action="/register" method="post">
        ...
        <div class="form__group">
            <div class="form__group-title">
                <span class="form__group-title-span">お名前</span>
            </div>
        ...
        <div class="form__group">
            <div class="form__group-title">
                <span class="form__group-title-span">メールアドレス</span>
            </div>
            <div class="form__error">
                <ul>
                    @error('email')
        ...
        <div class="form__group">
            <div class="form__group-title">
                <span class="form__group-title-span">パスワード</span>
            </div>
            <div class="form__error">
                <ul>
                    @error('password')
        ...
        <div class="form__group">
            ...
            <div class="form__group-input">
                <input type="password" class="form__group-input-item" name="password_confirmation" placeholder="例:coachtech1106">
            </div>
        </div>
