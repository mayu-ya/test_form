        ...
        <table class="table" border="1">
            <tr class="table-row">
                ...
                <td class="table-content">
                    <input type="text" class="table-content__input" name="last_name" value="{{ $contact['last_name'] }}">
                    <input type="text" class="table-content__input" name="first_name" value="{{ $contact['first_name'] }}">
                </td>
            </tr>
            <tr class="table-row">
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    <input type="text" class="table-content__input" name="tel_ful" value="{{ $contact['tel[0]'] }}{{ $contact['tel[1]'] }}{{ $contact['tel[2]'] }}">
