    ...
    <form action="" class="form">
        <table class="table" border="1">
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    <input type="text" class="table-content__input" name="content" value="{{ $category['content'] }}" readonly>
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    <textarea name="detail" class="table-content__input value="{{ $category->content ?? '' }}" readonly"></textarea>
                    <input type="hidden" name="category_id" value="{{ $contact['$contact_id'] }}">
                </td>
            </tr>
        </table>
