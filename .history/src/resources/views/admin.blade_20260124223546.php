                ...
                <td class="table__item">
                    <form class="form">
                        <div class="form__item">
                            <input type="text" class="form__item-input" name="name" value="{{ $contacts['last_name'] }}  {{ $contacts['first_name'] }}" readonly>
                            @php
                            $gendertext = [1 => '男性', 2 => '女性', 3=>'その他'][$contact['gender']];
                            @endphp
                            <input type="text" class="form__item-input" name="gender" value="{{ $gendertext }}" readonly>
                            <input type="text" class="form__item-input" name="email" value="{{ $contacts['email'] }}" readonly>
                            <input type="text" class="form__item-input" name="category_id"  value="{{ $contacts->category->content }}" readonly>
                        </div>
...
<div id="my-popover" popover>
    <form class="popover-form">
        ...
        <div class="popover-group">
            ...
            <div class="popover-group__item">
                <textarea class="popover-group__item-input" name="detail" value="{{ $contact['detail'] }}" readonly></textarea>
            </div>
        </div>
    </form>
