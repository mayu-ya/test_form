...
<div class="content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <label for="man">
                    <input type="radio" class="form__input-radio" name="gender" id="man" value="男性">男性
                </label>

                <label for="woman">
                    <input type="radio" class="form__input-radio" name="gender" id="woman" value="女性">女性
                </label>

                <label for="other">
                    <input type="radio" class="form__input-radio" name="gender" id="other" value="その他">その他
                </label>
            </div>
        </div>
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="emai" class="form__input-text" name="email" placeholder="例:test@example.com">
            </div>
        </div>
