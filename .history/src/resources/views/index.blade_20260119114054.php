...
<div class="content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="radio" class="form__input-radio" name="gender[0]" value="1">男性
                <input type="radio" class="form__input-radio" name="gender[1]" vlaue="2">女性
                <input type="radio" class="form__input-radio" name="gender[2]" Value="3">その他
            </div>
        </div>
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                ...
                <div class="form__input-tel">-</div>
                <input type="tel" class="form__input-text" name="tel[2s]" placeholder="5678">
            </div>
        </div>
