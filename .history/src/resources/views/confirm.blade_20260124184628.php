...
<class="content">
        ...
        <table class="table" border="1">
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    ...
                    @endphp
                    <p class="table-content__input">{{ $gendertext }}</p>
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    ...
                    <input type="hidden" name="tel" value="{{ $contact['tel'][0] }}{{ $contact['tel'][1] }}{{ $contact['tel'][2] }}">
                </td>
            </tr>
            <tr class="table-row">
            ...
            <tr class="table-row">
                ...
                <td class="table-content">
                    <textarea class="table-content__input" name="detail">{{ $contact['detail'] }}</textarea>
                </td>    
            </tr>
        </table>
    ...
    <form action="/" class="form__button-correct" method="post">
        @csrf
        <button class="form__button-correct-submit" type="button" onclick="history.back()">修正</button>
    </form>
