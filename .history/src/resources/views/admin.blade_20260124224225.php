    ...
    <form class="popover-form">
        ...
        <div class="popover-group">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="name" value="{{ $contacts['last_name'] }}  {{ $contacts['first_name'] }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                @php
                    $gendertext = [1 => '男性', 2 => '女性', 3=>'その他'][$contacts['gender']];
                @endphp
        ...
        <div class="popover-group">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="email" value="{{ $contacts['email'] }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="tel" value="{{ $contacts['tel'][0] }}{{ $contacts['tel'][1] }}{{ $contacts['tel'][2] }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="address" value="{{ $contacts['address'] }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="building" value="{{ $contacts['building'] }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="category_id"  value="{{ $contacts->category->content }}" readonly>
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <textarea class="popover-group__item-input" name="detail" value="{{ $contacts['detail'] }}" readonly></textarea>
            </div>
        </div>
    </form>
