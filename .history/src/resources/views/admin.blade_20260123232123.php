...
<div class="content">
    ...
    <div class="search">
        ...
        {{ $contacts->appends(request()->query())('vendor.pagination.custom-links') }}
    ...
    <form class="popover-form">
        ...
        <div class="popover-group">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="name">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="gender">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="email">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="tel">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="address">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="building">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="category_id">
            </div>
        </div>
        <div class="popover-group">
            <div class="popover-group__title">
            ...
            <div class="popover-group__item">
                <input type="text" class="popover-group__item-input" name="detail">
            </div>
        </div>
    </form>
