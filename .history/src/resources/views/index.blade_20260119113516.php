    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="text" class="form__input-text" name="first_name" placeholder="例:山田">
                <input type="text" class="form__input-text" name="last_name" placeholder="例:太郎">
            </div>
        </div>
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="radio" class="form__input-radio" name="gender[1]" value="1">男性
                <input type="radio" class="form__input-radio" name="gender[2]" vlaue="2">女性
                <input type="radio" class="form__input-radio" name="gender[3]" Value="3">その他
            </div>
        </div>
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="tel" class="form__input-text" name="tel[1]" placeholder="080">
                <div class="form__input-tel">-</div>
                <input type="tel" class="form__input-text" name="tel[2]" placeholder="1234">
                <div class="form__input-tel">-</div>
                <input type="tel" class="form__input-text" name="tel[3]" placeholder="5678">
            </div>
        </div>
