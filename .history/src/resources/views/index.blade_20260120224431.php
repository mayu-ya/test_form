...
<div class="content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <label for="man">
                    <input type="radio" class="form__input-radio" name="gender" id="man" value="1" value="{{ old('gender') }}">男性
                </label>

                <label for="woman">
                    <input type="radio" class="form__input-radio" name="gender" id="woman" value="2" value="{{ old('gender') }}">女性
                </label>

                <label for="other">
                    <input type="radio" class="form__input-radio" name="gender" id="other" value="3" value="{{ old('gender') }}">その他
                </label>
            </div>
        </div>
