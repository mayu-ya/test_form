...
<div class="content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="radio" class="form__input-radio" name="gender" value="男性">男性
                <input type="radio" class="form__input-radio" name="gender" vlaue="女性">女性
                <input type="radio" class="form__input-radio" name="gender" Value="その他">その他
            </div>
        </div>
