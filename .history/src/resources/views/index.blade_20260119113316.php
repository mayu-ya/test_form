...
<div class="content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="radio" class="form__input-radio" name="gender" value="1">男性
                <input type="radio" class="form__input-radio" name="gender" vlaue="2">女性
                <input type="radio" class="form__input-radio" name="gender" Value="3">その他
            </div>
        </div>
