...
<div class="content">
    ...
    <form class="form">
        ...
        <div class="form__group">
            ...
            <div class="form__input">
                <input type="radio" class="form__input-radio" name="gender">男性
                <input type="radio" class="form__input-radio" name="gender">女性
                <input type="radio" class="iform__input-radio" name="gender">その他
            </div>
        </div>
